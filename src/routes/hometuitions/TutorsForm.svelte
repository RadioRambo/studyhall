<div class="mx-6">
  <h1 class="font-semibold text-3xl mt-10">For Tutors</h1>
  <h2 class="mb-10">If you are looking for a part time job</h2>
  <form class="mx-0 md:mx-6" action="submit_form.php" method="POST">
    <input
    ...
    <textarea
      ...
      placeholder="Your qualification details"
      id="message"
      name="message"
      rows="5"
      required
